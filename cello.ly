...
%% page 1.3
  ...
  r2\stopTextSpan r8\mf <aes, f>~ 			| % bar 16
  q\p r8	
  \clef tenor
...
%% page 1.7
  ...
  r4 fis16( g') r8 ais,16( b') r8
  \clef bass								| % bar 41

%% page 1.8
  r4 r16 dis,,\upb\( g a\)
  r16 f16\dob gis,\upb r16			 		| % bar 42. Rehearsal letter C in reduction.
  b4:32
  \stemUp
  \times 2/3 { dis: g,: 
...
%% page 2.1
      ...
      \time 3/4
      r16 b,16\upb( cis'16) r16 r16 dis,,16\upb( cis'16 gis'16) r16 bes,16\upb( c'16) r16
											| % bar 62
...
%% page 2.3
      r4 \times 2/3 {c'4\tenuto\mf b,4\tenuto d'4\tenuto
											| % bar 72
...
%%%%% edit for parenthesised harmonic ----------------------
	...
	r8.
	\times 2/3 { <f,, bes>2\p\startTextSpan \clef tenor a''4^-\flageolet }
	\clef bass								| % bar 89

%%%%% end of edit for parenthesised harmonic ----------------------

      r16\stopTextSpan dis,,16\upb e'16 r16 r4 r8 			
      \override TextSpanner #'(bound-details left text) = "accelerando"
      \override TextSpanner #'(bound-details right text) = " a tempo"
      \override TextSpanner #'(bound-details right attach-dir) = #LEFT
      g,,16\upb\startTextSpan bes'16		| % bar 90
%%%%%
      R2.									| % bar 91
...
%%%%%
  ...
  f16: cis'8: dis,8:]} e'4 \times 4/5 {gis8:32\fp[ a,8:32 fis'16:32											| % bar 100
        ...
        r2 \times 4/5 {a8:32\fp[ bes8:32 g16:32	   | % bar 102
        g16:32 d8:32 b'8:32]} c4 r4				   | % bar 103
        r2 \times 4/5 {g'8:32[\fp bes,8:32 a'16:32 | % bar 104
%%%%%
        a16:32 d,8:32 b'8:32]} c,4 
			\times 4/5 {b'8:32\fp[ ais,8:32 cis'16:32     | % bar 105
        cis16:32 fis,8:32 a,!8:32]} gis'4 
			\times 4/5 {c!8:32\fp[ b,8:32 d'16:32         | % bar 106
        d16:32 a8:32 bes,8:32]} g'4 r4			          | % bar 107
%%%%% | % bar 108
        R2.
        \mark #7
        \time 2/4 R2
...
%%%%% end of edit for parenthesised harmonic ----------------------
        ...
        \tempo "Tempo 1º" 4=100
        \times 4/5 {r16 f,,16\p( aes16 ges'16) r16} r2
...
%%%%% | % bar 230 - ALV
        r2 \times 4/5 {f,,8:32\pp[ fis'8:32 gis,16:32
...
%%% Exeunt Ryan McClure
%%% FIXME: Substract 2 from previous bar count - done (ALV)
...
r8 <f' bes\harmonic>8\ff\arco   % arco missing in part.
      r4 r8 ees'16\f( d,) |
\mark #18
r4 \tuplet 3/2 { r8 fis'8\p d, } r4 		  | % bar 269
\tuplet 3/2 { e,4-- f'-- g'-- } r4 			  | % bar 270
f,16\f r8. r8 des'\pizz r8. d,!16 			  | % bar 271
r8 c,16\dob\piuf c\upb r4 r16 c''\pizz\p b, r | % bar 272

%% FIXME: Add 10 to the following bar count - done (ALV)
...
%275
  r2 e,16\downbow\arco e\upbow r8 |
